...
function createPopup(properties, attribute, layer, radius){
    ...
    var popupContent = "<p><b><u>Total GFR</u> </b><br>"
     popupContent += "<b>General Fertility Rate in " + year + ":</b> " + String(properties[attribute]) + " per 1000";
    }
    else if (att == 1) {
        var popupContent = "<p><b><u>Age Group 15 - 19</u> </b><br>"
    popupContent += "<p><b>General Fertility Rate in " + year + ":</b> " + String(properties[attribute]) + " per 1000</p>";
    }
        else if (att == 2) {
